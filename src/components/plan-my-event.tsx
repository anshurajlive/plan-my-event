...
import { FaGithub, FaLinkedin, FaTwitter, FaPeopleCarry } from "react-icons/fa";
          ...
          <VStack spacing={{ base: 2, md: 4, lg: 8 }}>
            ...
            >
              ...
              >
                <HStack spacing={6}>
                  <FormControl>
                    <FormLabel htmlFor="event">Plan my</FormLabel>
                    <Select id="event" placeholder=" ">
                  ...
                  <FormControl>
                    <FormLabel htmlFor="decoration">Decoration</FormLabel>
                    <Select id="decoration" placeholder=" ">
                  ...
                  <FormControl isRequired>
                    ...
                    <InputGroup>
                      <InputLeftElement children={<FaPeopleCarry />} />
                      <Input
                        type="number"
                        name="people"
                ...
                <HStack pt={4} spacing={6}>
                  <FormControl>
                    ...
                    <Select id="food" placeholder=" ">
                      <option>Veg</option>
                      <option>Non-Veg</option>
                      <option>I don't need</option>
                    </Select>
                  </FormControl>

                  <FormControl>
                    <FormLabel htmlFor="venue">Venue</FormLabel>
                    <Select id="venue" placeholder=" ">
                      <option>My home</option>
                      <option>Commercial Place</option>
                    </Select>
                  </FormControl>
